...
*   [ ] **Create Core Layout Components:**
    ...
    *   These components should be declared in `CoreModule` (from Task 03.0) and also **explicitly added to the `exports: []` array** of `CoreModule` to be usable by `AppComponent` (as per `../../../design/angular-frontend-architecture.md#2.2`).
    *   **Component Best Practices (refer to `../../../design/angular-frontend-architecture.md`):**
...
*   **Layout Component Practices:** For `HeaderComponent`, `FooterComponent`, and similar layout elements:
    ...
    *   Refer to `../../../design/angular-frontend-architecture.md` for detailed guidance on component design, state management, and coding style.
...
*   [ ] **Correlation IDs:** N/A
*   [ ] **Metrics:** N/A
*   **Notes:** Direct observability concerns for static layout components and basic routing are minimal. Adherence to `../../../design/observability-spec.md` will apply to more dynamic parts of the application. (Ref: Phase 0 Review - Observability)
...
*   **Notes:** Focus on structural integrity, basic rendering, and navigation. Adhere to `../../../design/test-spec.md`. (Ref: Phase 0 Review - Testing)
...
*   **Notes:** Foundational accessibility for page structure. Adhere to `../../../design/accessibility-spec.md`. (Ref: Phase 0 Review - Accessibility)
...
*   **Notes:** Minimal impact for this task, but flag any text content (e.g., in Header/Footer) for future i18n. Adhere to `../../../design/i18n-spec.md`. (Ref: Phase 0 Review - I18n)
