...
*   **Documentation:** These design decisions and their rationale were logged in `design/design-log.md` (Entry: "User Model: Nullable Fields, UserType Enum, and Authorization Flags").
...
*   **Challenge 1: Initial Empty Migration Script**
    ...
    *   **Learning for Cascade/Future Reference:** When `alembic revision --autogenerate` produces an empty script for new or modified tables, the primary suspect is missing model imports in `alembic/env.py` prior to `target_metadata` assignment.
...
*   Security: `../../../design/security-spec.md` (adjust path as needed)
*   Observability: `../../../design/observability-spec.md` (adjust path as needed)
*   Testing: `../../../design/test-spec.md` (adjust path as needed)
*   Accessibility: `../../../design/accessibility-spec.md` (adjust path as needed)
*   Internationalization (i18n): `../../../design/i18n-spec.md` (adjust path as needed)
