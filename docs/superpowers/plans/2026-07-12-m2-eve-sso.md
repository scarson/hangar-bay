...
| 9 — Docs | ✅ IMPLEMENTED — PR OPEN (stacked on Phase 8), awaiting CI + codex gate | `3d28f7e`, `94d84f1` | spec SPEC-COMPLIANT; accuracy APPROVED (all doc claims code-verified); traps → TEST-8/9/10 + ENV-6 |
