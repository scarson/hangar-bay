...
|---|---|---|---|
| 0 — CI workflow | 🚧 IN PROGRESS (claimed 2026-07-13T01:39Z, `claude/m2-phase0-ci`) | — | must be green on the pre-SSO tree |
...
**Execution Status:** 🚧 IN PROGRESS — claimed 2026-07-13T01:39Z on `claude/m2-phase0-ci`
