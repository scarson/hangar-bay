...
async def test_create_esi_type_cache(db_session):
...
async def test_read_esi_type_cache(db_session):
...
async def test_update_esi_type_cache(db_session):
...
async def test_delete_esi_type_cache(db_session):
    ...
    # Constraint Tests
async def test_unique_type_id_constraint(db_session):
...
async def test_not_null_constraints(db_session):
    ...
    # JSON Field Tests
async def test_dogma_attributes_json_field(db_session):
...
async def test_dogma_effects_json_field(db_session):
...
async def test_type_id_index_performance(db_session):
...
async def test_category_id_index_performance(db_session):
...
async def test_upsert_new_record(db_session):
...
async def test_upsert_existing_record(db_session):
...
async def test_large_json_fields(db_session):
...
async def test_null_json_fields_handling(db_session):
...
async def test_concurrent_upserts(db_session):
